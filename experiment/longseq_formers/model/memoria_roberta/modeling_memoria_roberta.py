...
from .configuration_memoria_roberta import MemoriaRobertaConfig

logger = logging.get_logger(__name__)


class MemoriaRobertaOutput(nn.Module):
...
# Copied from MemoriaBertLayer with Bert->Roberta
class MemoriaRobertaLayer(nn.Module):
    def __init__(self, config: MemoriaRobertaConfig, use_memory_attention: bool = False):
        super().__init__()
        ...
        if self.use_memory_attention:
            self.memory_attention = RobertaAttention(config)
        self.intermediate = RobertaIntermediate(config)
        self.output = MemoriaRobertaOutput(config)
...
# Copied from MemoriaBertEncoder with Bert->Roberta
class MemoriaRobertaEncoder(nn.Module):
    def __init__(self, config: MemoriaRobertaConfig):
        super().__init__()
        self.config = config
        self.layer = nn.ModuleList(
            [
                MemoriaRobertaLayer(config, use_memory_attention=i > config.memory_layer_index)
...
class MemoriaRobertaPreTrainedModel(PreTrainedModel):
    """
    An abstract class to handle weights initialization and a simple interface for downloading and loading pretrained
    models.
    """

    config_class = MemoriaRobertaConfig
    base_model_prefix = "memoria_roberta"
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, MemoriaRobertaEncoder):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs):
        ...
        if config.model_type == "memoria_roberta":
            return super().from_pretrained(pretrained_model_name_or_path, *model_args, **kwargs)
        elif config.model_type == "roberta":
            return cls.from_pretrained_roberta(pretrained_model_name_or_path, *model_args, **kwargs)
        else:
            raise ValueError("Unsupported model type")

    @classmethod
    def from_pretrained_roberta(cls, *args, **kwargs):
        raise NotImplementedError


class MemoriaRobertaModel(MemoriaRobertaPreTrainedModel):
    """
    ...
    def __init__(self, config, add_pooling_layer=True):
        ...
        self.encoder = MemoriaRobertaEncoder(config)
    ...
    @classmethod
    def from_pretrained_roberta(cls, pretrained_path: str, *args, **kwargs) -> "MemoriaRobertaModel":
        bert = MemoriaRobertaModel.from_pretrained(pretrained_path, *args, **kwargs)
        config = MemoriaRobertaConfig(**bert.config.to_dict())
        config.model_type = MemoriaRobertaConfig.model_type
        model = cls(config)
        model.load_state_dict(bert.state_dict(), strict=False)
        return model


class MemoriaRobertaForSequenceClassification(MemoriaRobertaPreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"position_ids"]
    ...
    def __init__(self, config):
        ...
        self.roberta = MemoriaRobertaModel(config, add_pooling_layer=False)
    ...
    def from_pretrained_roberta(
        cls, pretrained_path: str, *args, **kwargs
    ) -> "MemoriaRobertaForSequenceClassification":
        bert = RobertaForSequenceClassification.from_pretrained(pretrained_path, *args, **kwargs)
        config = MemoriaRobertaConfig(**bert.config.to_dict())
        config.model_type = MemoriaRobertaConfig.model_type
        model = cls(config)
        model.load_state_dict(bert.state_dict(), strict=False)
...
MemoriaRobertaModel.register_for_auto_class("AutoModel")
MemoriaRobertaForSequenceClassification.register_for_auto_class("AutoModelForSequenceClassification")
AutoModel.register(MemoriaRobertaConfig, MemoriaRobertaModel)
AutoModelForSequenceClassification.register(MemoriaRobertaConfig, MemoriaRobertaForSequenceClassification)
