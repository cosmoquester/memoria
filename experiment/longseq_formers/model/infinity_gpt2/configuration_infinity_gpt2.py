...
class InfinityGPT2Config(PretrainedConfig):
    """
    ...
    def __init__(
        ...
        mask_type="cnn",
        mask_dropout=0.1,
        longterm_attention_dropout=0.1,
        use_affines=True,
        use_kl_regularizer=True,
        use_sticky_memories=True,
        mu_0=-1.0,
        sigma_0=0.05,
        kl_lambda=1e-6,
        detach_recursive_outputs=True,
        **kwargs
    ):
        ...
        self.longterm_attention_dropout = longterm_attention_dropout
        self.use_affines = use_affines
        self.use_kl_regularizer = use_kl_regularizer
        self.use_sticky_memories = use_sticky_memories
        self.mu_0 = mu_0
        self.sigma_0 = sigma_0
        self.kl_lambda = kl_lambda
        self.detach_recursive_outputs = detach_recursive_outputs
...
InfinityGPT2Config.register_for_auto_class()
AutoConfig.register("infinity_gpt2", InfinityGPT2Config)
