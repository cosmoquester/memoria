...
class MemoriaBertConfig(PretrainedConfig):
    r"""
    Args:
...
MemoriaBertConfig.register_for_auto_class()
AutoConfig.register("memoria_bert", MemoriaBertConfig)
